      ...
      <main>
        <form>
            <h1 class="h1 mb-3vmax fw-normal" id="textoHola">¡Hola, <br />de nuevo!<br /> </h1>
                ...
                <button type="button" class="btn btn-link mb-2vmax mt-2vmax" id="letraform" style="font-size: 13px;">
                        Olvide mi Contraseña
                </button>
                <a href="register.html"><button type="button" class="btn btn-link mb-auto mt-auto" id="letraform" style="font-size: 13px;">
