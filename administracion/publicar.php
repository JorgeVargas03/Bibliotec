...
<body >
    <header class="bg-primary py-2" >
        <div class="container d-flex align-items-center" style="margin-left: 7%;">
            <!-- Logo y título -->
            <div class="logo">
    ...
    <div class="container-fluid" style="height:41.92vmax;" >
        <div class="row" style="height:100%;">
            ...
            <div class="flex-shrink-0 p-3 " style="width: 15%; background-color:#F07B12;">
                <ul class="list-unstyled">
                  ...
                  <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" id="letrabardos" 
                    ...
                    <div class="collapse" id="dashboard-collapse">
                      <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ingeniería Civil</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ingeniería Eléctrica</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ing. en Gestión Empresarial</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ing. en Sistemas Computacionales</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ingeniería Industrial</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ingeniería Mecatrónica</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Ingeniería Química</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Licenciatura en Administración</a></li>
                      </ul>
                    </div>
                  </li>
                  <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" id="letrabardos" data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false">
                      Contacto
                    </button>
                    <div class="collapse" id="orders-collapse">
                      <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Información de contacto</a></li>
                      </ul>
                    </div>
                  </li>
                  <li class="border-top my-3"></li>
                  <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" id="letrabarcuatro" data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false">
                        <svg class="bi pe-none" width="1.3vmax" height="1.3vmax"><use xlink:href="#people-circle"/></svg>
                        <span style="margin-top:0.3vmax; margin-left: 0.4vmax;">Cuenta</span>
                    </button>
                    <div class="collapse" id="orders-collapse">
                      <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Mi Perfil</a></li>
                        <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded" id="letrabartres">Cerrar Sesión</a></li>
                      </ul>
                    </div>
                  </li>
                </ul>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="margin-left: 0.1%;" >
                ...
                <div class="container" style="margin-top: 3.6%; align-items: center;">
                    ...
                    <h2 style=" margin-left: 0.1% ; margin-bottom: 1.2vmax;"><span class="material-symbols-outlined"> library_add </span>
                        <b style="margin-left:0.5vmax;" class="textogran">Nueva Publicación</b></h2>       
                    ...
                    <form class="row g-3 formulario mt-2 mb-2vmax">
                        <div class="col-md-8 mt-1">
                          ...
                          <div class="col-md-4 mt-1 mb-2">
                            ...
                            <input class="form-control"  style="border-color: rgb(179, 179, 179); font-weight: 500;" type="text" 
                                placeholder="@lireramirezve" aria-label="Disabled input example" disabled>
                          </div>
                        <div class="mb-3 mt-2">
